...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default="NeuroClip")
    ...
    wandb_run_name = f"k{args.split_idx}_{args.accum_freq}x_{args.batch_size}b_{args.patch_size}p"
    ...
    callback_config = get_callback_config(
        ...
        experiment= "NeuroCLIP" if run_type == "from_scratch" else args.experiment,
    )

    print("run_type: ", run_type)   
    print("run_name: ", args.name or f"{run_type}_{task_config.experiment}")
    print("group in wandb: ", "NeuroCLIP" if run_type == "from_scratch" else args.experiment)
